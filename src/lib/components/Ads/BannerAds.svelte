<script lang="ts">
    ...
    function injectAd(container: HTMLDivElement) {
        ...
        // Script 2: invoke.js (riêng từng ad key)
        const invokeScript = document.createElement("script");
        invokeScript.type = "text/javascript";
        invokeScript.src = `https://mistletoeframesethel.com/${adKey}/invoke.js`;
        ...
        // Fallback: nếu sau 5s vẫn chưa load xong thì tắt skeleton
