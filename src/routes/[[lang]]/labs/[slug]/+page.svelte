<script lang="ts">
    ...
    $effect(() => {
        // Re-run this block whenever the user navigates to a new lab post
...
<Seo title="{data.title} - UploadLess Labs" description={data.description} noHreflang={false} />
            ...
            <article class="article-main">
                ...
                <div class="author-box">
                    ...
                    <div class="author-info">
                        ...
                        <p class="author-bio">{dict['blog.author_bio'] || 'Web Developer & Content Creator'}</p>
                    </div>
                </div>
