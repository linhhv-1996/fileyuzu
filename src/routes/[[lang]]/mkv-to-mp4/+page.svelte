...
<div class="hero">
    ...
    <p>{t('mkv_to_mp4.hero.description', dict)}</p>
</div>
...
<div class="grid">
    <main>
        <VideoConverter 
            ...
            inputFormats=".mkv,video/x-matroska" 
            outputFormats={['mp4']} 
            sampleVideoPath="/file_sample_1280x720.mkv" 
        />
        <HowToUse title={t('mkv_to_mp4.how_to_use.title', dict)} steps={Array.isArray(t('mkv_to_mp4.how_to_use.steps', dict)) ? t('mkv_to_mp4.how_to_use.steps', dict) : []} />
        <WhyUse title={t('mkv_to_mp4.why_use.title', dict)} benefits={Array.isArray(t('mkv_to_mp4.why_use.benefits', dict)) ? t('mkv_to_mp4.why_use.benefits', dict) : []} />
        <Faq title={t('mkv_to_mp4.faq.title', dict)} items={Array.isArray(t('mkv_to_mp4.faq.items', dict)) ? t('mkv_to_mp4.faq.items', dict) : []} />
    </main>
