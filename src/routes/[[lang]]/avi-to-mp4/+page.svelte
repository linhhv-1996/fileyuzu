<script lang="ts">
    ...
    let converterTexts = $derived({
        uploadTitle: t('avi_to_mp4.upload.title', dict),
        uploadSubtitle: t('avi_to_mp4.upload.subtitle', dict),
        btnSelect: t('avi_to_mp4.upload.btn_select', dict),
        btnSample: t('avi_to_mp4.upload.btn_sample', dict),
        hint: t('avi_to_mp4.upload.hint', dict),
...
<Seo title={t('avi_to_mp4.seo.title', dict)} description={t('avi_to_mp4.seo.description', dict)} />
