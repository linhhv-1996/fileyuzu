<script lang="ts">
    ...
    let converterTexts = $derived({
        uploadTitle: t('webm_to_mp4.upload.title', dict),
        uploadSubtitle: t('webm_to_mp4.upload.subtitle', dict),
        btnSelect: t('webm_to_mp4.upload.btn_select', dict),
        btnSample: t('webm_to_mp4.upload.btn_sample', dict),
        hint: t('webm_to_mp4.upload.hint', dict),
...
<Seo title={t('webm_to_mp4.seo.title', dict)} description={t('webm_to_mp4.seo.description', dict)} />
